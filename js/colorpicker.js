...
function colorpicker() {
	var FinalHexCode = "",
		...
		styleLine = [],
		codeLine = [],
		finalCodeOutput = ["<script src='http://gordonlambot.be/tfe/site/js/videolayer.min.js'></script>", "<link href='http://gordonlambot.be/tfe/site/css/videolayer.css' rel='stylesheet'>"],
	...
	function fillColorSample(Element, width, height, r, g, b, a) {
		...
		if(Element == Samples[0]) {
			if(string != "rgba(32, 32, 32, 0.8)" && string != "rgba(31, 31, 31, 0.8)") {
				if(a == 1) {
					...
					codeLine[0] = ".vl_ui .vl_background, .vl_thumbnail:after, <br> .vl_background .vl_timetooltip, button:after { <div class='code'> background: " + hexoutput + "; </div> } <br>";
				}
				else {
					styleLine[0] = ".vl_ui .vl_background, .vl_thumbnail:after, .vl_background .vl_timetooltip, button:after { background: rgba(" + r + ", "+ g +", "+ b +", "+ a + "); }";
					codeLine[0] = ".vl_ui .vl_background, .vl_thumbnail:after, <br> .vl_background .vl_timetooltip, button:after { <div class='code'> background: rgba(" + r + ", "+ g +", "+ b +", "+ a + "); </div> } <br>";
				}
			}
			else  {
				styleLine[0] = "";
			...
			if(string != "rgba(90, 184, 28, 1)") {
				if(a == 1) {
					...
					codeLine[1] = ".vl_ui .vl_active, .vl_ui button:hover, <br> .vl_active:hover button:after { <div class='code'> color: " + hexoutput + "; </div> } <br>";
					codeLine[1]+= ".vl_ui .vl_current { <div class='code'> background: " + hexoutput + "; </div> } <br>";
				}
				else {
					...
					codeLine[1] = ".vl_ui .vl_active, .vl_ui button:hover, <br> .vl_active:hover button:after { <div class='code'> color: rgba(" + r + ", "+ g +", "+ b +", "+ a + "); </div> } <br>";
					codeLine[1]+= ".vl_ui .vl_current { <div class='code'> background: rgba(" + r + ", "+ g +", "+ b +", "+ a + "); </div> } <br>";
				}
			}
			else  {
				styleLine[1] = "";
			...
			if(string != "rgba(235, 235, 235, 1)") {
				if(a == 1) {
					...
					codeLine[2] = ".vl_ui, button, button:after, <br> .vl_current div { <div class='code'> color: " + hexoutput + "; </div> } <br>";
					codeLine[2]+= ".vl_ui .vl_maincolor, <br> figure.vl_current, figure:hover { <div class='code'> background: " + hexoutput + "; </div> } <br>";
				}
				else {
					...
					codeLine[2] = ".vl_ui, button, button:after, <br> .vl_current div { <div class='code'> color: rgba(" + r + ", "+ g +", "+ b +", "+ a + "); </div> } <br>";
					codeLine[2]+= ".vl_ui .vl_maincolor, <br> figure.vl_current, figure:hover { <div class='code'> background: rgba(" + r + ", "+ g +", "+ b +", "+ a + "); </div> } <br>";
				}
			}
			else  {
				styleLine[2] = "";
		...
		else codeTag.innerHTML = finalCodeOutput[0] + "<br>" + finalCodeOutput[1] + "<br>&lt;style&gt;<div class='code'>" +codeLine[0] + codeLine[1] + codeLine[2] + "</div>&lt;/style&gt;";
		if(firstclick) {
			window.scrollTo(0,0);
			firstclick = false;
		}
